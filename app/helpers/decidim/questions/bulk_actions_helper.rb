  ...
  module Questions
    module BulkActionsHelper
      ...
      def bulk_actions_dropdown
        render partial: "decidim/questions/bulk_actions/dropdown"
      end
      ...
      def bulk_action_recategorize
        render partial: "decidim/questions/bulk_actions/recategorize"
      end
      ...
      def bulk_categories_select(collection)
        ...
        prompt = t("decidim.questions.admin.questions.index.change_category")
