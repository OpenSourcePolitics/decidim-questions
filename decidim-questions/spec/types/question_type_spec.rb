...
module Decidim
  module Questions
    describe QuestionType, type: :graphql do
      ...
      let(:model) { create(:question, :with_votes, :with_endorsements, component: component) }
      ...
      describe "voteCount" do
        ...
        context "when votes are not hidden" do
          it "returns the amount of votes for this question" do
            expect(response["voteCount"]).to eq(model.votes.count)
          end
        end

        context "when votes are hidden" do
          let(:component) { create(:question_component, :with_votes_hidden) }
      ...
      describe "endorsementsCount" do
        ...
        it "returns the amount of endorsements for this question" do
      ...
      describe "endorsements" do
        ...
        it "returns the endorsements this question has received" do
      ...
      describe "state" do
        ...
        it "returns the question's state" do
      ...
      describe "address" do
        ...
        it "returns the address of this question" do
