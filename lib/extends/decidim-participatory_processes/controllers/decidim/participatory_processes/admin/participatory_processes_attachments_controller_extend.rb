...
module Decidim
  module Questions
    module ParticipatoryProcesses
      module Admin
        module ParticipatoryProcessAttachmentsControllerExtend
...
Decidim::ParticipatoryProcesses::Admin::ParticipatoryProcessAttachmentsController.class_eval do
  prepend(Decidim::Questions::ParticipatoryProcesses::Admin::ParticipatoryProcessAttachmentsControllerExtend)
end
