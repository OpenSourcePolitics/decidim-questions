...
module Decidim
  module Questions
    module ParticipatoryProcesses
      module Admin
        module ComponentsControllerExtend
...
Decidim::ParticipatoryProcesses::Admin::ComponentsController.class_eval do
  prepend(Decidim::Questions::ParticipatoryProcesses::Admin::ComponentsControllerExtend)
end
