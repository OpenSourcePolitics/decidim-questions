  ...
  module Questions
    describe QuestionEndorsementsController, type: :controller do
      ...
      describe "As Organization" do
        ...
        describe "endorsing a Question" do
          context "when endorsements are enabled" do
            ...
            it "allows endorsing" do
              ...
              expect(QuestionEndorsement.last.user_group).to eq(user_group)
            end
          end
        ...
        describe "As User unendorsing a Question" do
          before do
            create(:question_endorsement, question: question, author: user, user_group: user_group)
          end
